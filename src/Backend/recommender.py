...
def test_function():
    column_names = ['track_name','tempo', 'energy']
    ...
    sound_properties = similar_songs.loc[:,['energy']]

    print(sound_properties)
    similar_songs['similarity with song'] = cosine_similarity(sound_properties, [0.2])
